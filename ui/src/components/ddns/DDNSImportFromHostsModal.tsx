...
export default function DDNSImportFromHostsModal({ onClose, onSuccess }: DDNSImportFromHostsModalProps) {
  ...
  return (
    <ModalShell isOpen onClose={handleClose} closeOnBackdrop={false} panelClassName="max-w-2xl" labelledById="ddns-import-title">
      <div>
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <h2 id="ddns-import-title" className="text-xl font-semibold text-slate-900 dark:text-white">
              {t('importFromHosts')}
            </h2>
            <button
              onClick={onClose}
