...
func (s *PartitionScheduler) createPartitions() {
	...
	// Stats partitions are pre-generated by migration 009 for 10 years (2025-12 to 2035-12)
	// Dynamic partition creation via create_monthly_partitions() is no longer used
	// because it was susceptible to timezone bugs in non-UTC environments.
